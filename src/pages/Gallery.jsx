      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <button 
            ...
            className="bg-olive-700 hover:bg-olive-800 text-white px-6 py-3 rounded-full font-semibold transition-colors shadow-lg hover:shadow-xl"
          >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  activeTab === key
                    ...
                    : 'bg-white text-stone-600 hover:bg-olive-50 border border-stone-200'
                }`}
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
            ...
            <div key={photo.id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-end">
                  <div className="text-olive-700 text-xs font-medium">
          ...
          <div 
            onClick={() => setShowUploadModal(true)}
            className="bg-white rounded-xl border-2 border-dashed border-stone-300 hover:border-olive-700 hover:text-olive-700 transition-colors cursor-pointer aspect-square flex flex-col items-center justify-center text-stone-400 group"
          >
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-stone-200 text-center">
          <h3 className="text-xl text-stone-700 mb-4 font-semibold">
            ...
            <div>
              <div className="text-2xl font-bold text-olive-700">{totalPhotos}</div>
              <div className="text-sm text-stone-600">
                {language === 'es' ? 'Publicaciones' : 'Posts'}
              </div>
            </div>
            <div>
              <div className="text-2xl font-bold text-olive-700">{totalUploads}</div>
              <div className="text-sm text-stone-600">
                {language === 'es' ? 'Fotos Totales' : 'Total Photos'}
              </div>
            </div>
            <div>
              <div className="text-2xl font-bold text-olive-700">{totalContributors}</div>
              <div className="text-sm text-stone-600">
            ...
            <div className="bg-white rounded-xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto hide-scrollbar">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">                <div className="border-2 border-dashed border-stone-300 rounded-lg p-8 text-center">
                  ...
                  <label 
                    ...
                    className="bg-olive-700 text-white px-4 py-2 rounded-lg hover:bg-olive-800 transition-colors cursor-pointer inline-block"
                  >
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full p-3 border border-stone-300 rounded-lg focus:border-olive-700 focus:outline-none"
                    disabled={isUploading}
                  >
                ...
                <button 
                  type="submit"
                  disabled={isUploading}
                  className="w-full bg-olive-700 text-white py-3 rounded-lg hover:bg-olive-800 transition-colors font-semibold disabled:bg-stone-300 disabled:cursor-not-allowed"
                >
                  {isUploading 
            ...
            <div className="bg-white rounded-xl p-6 max-w-md w-full shadow-2xl">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-olive-700 text-white py-3 rounded-lg hover:bg-olive-800 transition-colors font-medium"
                >
