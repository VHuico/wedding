              ...
              <div className="space-y-3">
                ...
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  <p className="text-sm text-green-800 font-medium mb-2">
                    {language === 'es'
                      ? '💬 Para reservar, contáctalos por WhatsApp'
                      : '💬 To book, contact them via WhatsApp'
                    }
                  </p>
                  <p className="text-xs text-green-700">
                    {language === 'es'
                      ? 'Pregunta sobre precios y disponibilidad para las fechas Feb 12-16 y menciona que eres invitado de la boda de Víctor y Landy.'
                      : 'Ask about pricing and availability for Feb 12-16 dates and mention you are a guest of Victor and Landy\'s wedding.'
                    }
                  </p>
                </div>

                <button
                  onClick={() => window.open('https://wa.me/529901811333', '_blank')}
