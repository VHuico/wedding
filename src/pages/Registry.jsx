    ...
    <div className="min-h-screen py-16 px-6 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {/* Amazon Registry Section - Featured First */}
          <div className="bg-white rounded-3xl p-4 md:p-8 shadow-lg border-2 border-orange-500 hover:shadow-xl transition-shadow">
          ...
          {/* Banking Options Header */}
          <div className="text-center">
            <h3 className="text-xl md:text-2xl font-semibold text-stone-700 mb-2">
              {language === 'es' ? 'O Contribuye Directamente' : 'Or Contribute Directly'}
            </h3>
            <p className="text-sm text-stone-600">
              {language === 'es'
                ? 'También puedes enviarnos un regalo monetario a través de estas opciones'
                : 'You can also send us a monetary gift through these options'
              }
            </p>
          </div>
